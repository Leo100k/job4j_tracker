...
class BankServiceTest {
    ...
    void deleteUserIsTrue() {
        ...
        User userLeo = new User("100", "Leo");
        BankService bank = new BankService();
        bank.addUser(first);
        bank.addUser(second);
        bank.addUser(userLeo);
    ...
    void addAccount() {
        User user = new User("3434", "Petr Arsentev");
        User userLeo = new User("1000", "Leo");
        BankService bank = new BankService();
        bank.addUser(user);
        bank.addUser(userLeo);
        bank.addAccount(user.getPassport(), new Account("5546", 150D));
        bank.addAccount(userLeo.getPassport(), new Account("7777", 2000));
       // bank.addAccount(userLeo.getPassport(), new Account("8888", 3000));
       // bank.addAccount(userLeo.getPassport(), new Account("8888", 5000));
       // bank.addAccount(userLeo.getPassport(), new Account("9999", 3000));
